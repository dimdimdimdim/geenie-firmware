 ...
 *
 * Copyright 1991, 2015000, 2001 by Lucent Technologies.
 *
...
static CriticalSection sections[2];

#define IEEE_8087
#define MALLOC SysCalls::malloc
#define FREE SysCalls::free
#define MULTIPLE_THREADS
#define ACQUIRE_DTOA_LOCK(n)	sections[n].lock();
#define FREE_DTOA_LOCK(n)		sections[n].unlock();
#define PRIVATE_MEM				512
